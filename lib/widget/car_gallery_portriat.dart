...
class CarGalleryPortrait extends StatelessWidget {
      ...
      return Stack(
        ...
        children: [
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: const Padding(
                    padding: EdgeInsets.only(left: 20, right: 40,top: 100),
          ...
          AnimatedPositioned(
            duration: const Duration(milliseconds: 1000),
            curve: Curves.ease,
            bottom: detailsPageController.openGallery.value ? Get.height * 0.2 : - Get.height * 0.17,
            child: SizedBox(
                width: Get.width * 0.8,
