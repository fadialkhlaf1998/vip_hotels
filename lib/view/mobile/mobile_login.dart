                  ...
                  child: SizedBox(
                    ...
                    child: Stack(
                      ...
                      children: [
                        Positioned(
                            top: 0,
                            child: CustomImageContainer(width: 1, height: 0.3, image: 'assets/images/login_bg.jpg')),
                        Positioned(
                          bottom: 0,
                          child: _inputData(),
                        )
  ...
  _inputData(){
    return Container(
      ...
      child: Column(
        ...
        children: [
          CustomLogoBlack(width: 0.5, height: 0.15, tag: 'logo'),
          ...
          Container(
            ...
            child: RichText(
              text: const TextSpan(
                  ...
                  children: [
                    TextSpan(text: 'VIP', style: TextStyle(fontSize: 28,fontWeight: FontWeight.bold, color: AppStyle.vipBlue)),
                  ]
              ),
